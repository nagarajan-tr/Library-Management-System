...
<body>
  <!-- <div id="container">
    ...
    <div id="wrapper">
      <h3 id="heading">View Request Details</h3>
        <?php
        $sql = "SELECT STUDENT.NAME,request.MES,request.LOGS from STUDENT inner join request on 
        ...
        if ($res->num_rows > 0) {
          ...
          echo "<p class='error'>No requests Records Found </p>";
        }
        ?>
    </div>
    <div id="navi">
  ...
  <h1 class="header">Issues Books Details</h1>
