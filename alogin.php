...
<body>
  <div id="container">
    ...
    <div id="wrapper">
      <!-- <h2 id="heading">Admin Login Here</h2> -->
      <form action="alogin.php" method="post">
        <div id="center">
          ...
          <input type="text" name="aname" placeholder="admin" required><br>
          <label><b>Password</b></label>
          <input type="password" name="apass" placeholder="*******" required><br>
          ...
          <div class="full">
            <div class="in">
              ...
              <div class="imgcontainer">
                <img src="Alogin.jpg" width="50" />
              </div>

              <div class="container">
                <label for="uname"><b>Name</b></label>
                <input type="text" placeholder="Admin" name="aname" required />
