...
<body>
  <!-- <div id="container">
    ...
    <div id="wrapper">
      <h3 id="heading">View Comments Details</h3>
        <?php
        $sql = "SELECT book.BTITLE,student.NAME,comment.COMM,comment.LOGS from comment inner join book
        on book.BID=comment.BID inner join student on comment.SID=student.ID";
        $res = $db->query($sql);
        if($res->num_rows>0)
        {
            // print_r($res);
  ...
  <h1 class="header">View Comments Details</h1>
